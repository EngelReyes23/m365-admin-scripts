...
localize() {
    ...
    if [[ "$LANGUAGE" == "en" ]]; then
        ...
        value="${value//ubicación anidada/nested location}"
        value="${value//Número/Number}"
        value="${value//Ejemplo/Example}"
        value="${value//aviso/warning}"
        value="${value//crítico/critical}"
        value="${value//Nombre/Name}"
        value="${value//Estado/Status}"
        value="${value//Motivo/Reason}"
        value="${value//TipoSincronizacion/SyncType}"
        value="${value//TipoElemento/ItemType}"
        value="${value//LongitudRutaLocal/LocalPathLength}"
        value="${value//BytesUTF8RutaLocal/LocalPathUTF8Bytes}"
        value="${value//LongitudRutaCloud/CloudPathLength}"
        value="${value//LongitudNombre/NameLength}"
        value="${value//RutaCompleta/FullPath}"
        value="${value//Rutas de usuario analizadas/User paths analyzed}"
        value="${value//Rutas en AVISO/Paths with WARNINGS}"
        value="${value//Rutas CRITICAS/CRITICAL paths}"
    fi
